...
- App: `lab/apps/vuln_rag_agent/`
- Attacks: Day001 pack in `lab/attacks/`
- Harness: `lab/eval/harness/run_baseline.py`

## Metrics snapshot

- Vulnerable metrics: `lab/eval/baseline_metrics.vuln.json`
- Defended metrics: `lab/eval/baseline_metrics.defended.json`
...
- Indirect injection was blocked by provenance allowlist + sanitization (`lab/defenses/retrieval_firewall/`).
- Unauthorized tool access was blocked by policy gate (`lab/defenses/tool_gate/`).
