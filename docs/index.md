...
Welcome to the AI Hub — a comprehensive collection of learning resources, notes, and guides covering the modern AI stack.

## 📚 Comprehensive Guides

Start with these consolidated, high-signal references:
...
```
ai-hub/
├── retrieval-augmented-systems/   # RAG, context engineering, secure RAG
├── agents/                        # Agent framework, protocols (MCP, A2A)
├── ai-coding/                     # AI-assisted development patterns
├── ai-product-strategy/           # Product and GTM for AI
├── evalops/                       # Evaluation operations
├── model-space/                   # Model architectures and research
├── ai-startups/                   # Startup tracking and analysis
├── ai-security-and-governance/    # Security, governance, compliance
├── inference-engineering/         # Serving and optimization
...
Most notes are labeled with verification status:

- **Verified** — Cross-checked against primary sources
- **To verify** — Sourced from transcripts/summaries, awaiting verification

Always verify claims before relying on them for production decisions.
