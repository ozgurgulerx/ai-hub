...
- Jamba 3B hybrid Transformer+SSM reasoning model (AI21; Noiz summary, to verify): `notes/building-jamba-3b-hybrid-transformer-state-space-reasoning-model-ai21-noiz-summary.md`
